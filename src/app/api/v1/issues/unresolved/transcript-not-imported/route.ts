 ...
 * transcript was delivered by TranscribeMe (transcribeme.transcribeme_pull)
 * but has not yet been registered in transcript_files by the import crawler.
 *
...
export async function GET(request: Request): Promise<Response> {
    ...
    const { rows, totalRows } = await Transcribeme.getDownloadedNotImported(limit, offset);
